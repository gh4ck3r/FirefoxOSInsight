...
function logcat() {
  ...
  QueryInterface: XPCOMUtils.generateQI([Ci.adbIlogcat]),
  ...
  /*************************************************************************/
  connect : function() {
    this.transport = nsISocketTransportService.createTransport(
        null,0,prefs.getCharPref("host"),prefs.getIntPref("port"),null);
    cmd_logcat.reset();
  },
